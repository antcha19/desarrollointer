...
public class opcion extends JFrame {
    ...
    // se utiliza para mostrar los cambios en el tipo de letra
    private JTextField fieldText;
    // tipo de letra para texto simple
    private Font letterTypeSimple;
    // tipo de letra para texto en bold
    private Font letterTypeBold;
